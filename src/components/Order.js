...
const Order = () => {
    return (
        <div className="flex bg-black ">
            ...
            <p className='text-2xl text-white mb-5 mt-5'>With Burkey, you can order in bulk with ease, whether you're feeding a crowd at a party, stocking up for a busy week, 
            ...
            <button className='bg-white hover:bg-gray-200 text-black-500 py-2 px-4 rounded-3xl'>Contact Us</button>
            </div>
