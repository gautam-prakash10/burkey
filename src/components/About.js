...
const About = () => {
  return (
      <div className="flex bg-black ">
          ...
          <p className='text-5xl text-yellow-400 mb-5 mt-20'>About Burkey</p>
          <p className='text-xl text-white mb-5 mt-7'>Burkey - Niwala Burkey delivers authentic and Delectable North Indian and Mughali Cuisine.
